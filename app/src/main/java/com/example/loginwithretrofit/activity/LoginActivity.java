...
public class LoginActivity extends Activity implements OnClickListener {
            ...
            case R.id.btnLogin:
                ...
                if (edtEmail.getText().toString().length() == 0) {
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Ingresa Email", Toast.LENGTH_LONG).show();
                    edtEmail.setError("Ingresa Email");
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Ingresa Contraseña", Toast.LENGTH_LONG).show();
                    edtPassword.setError("Ingresa Contraseña");
    ...
    private void showUsers() {
        ...
        if (InternetConnection.checkConnection(getApplicationContext())) {
                ...
                public void onResponse(Call<UserList> call, Response<UserList> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (login) {
                            ...
                            Toast.makeText(getApplicationContext(),
                                    "Contraseña ó Correo Invalido", Toast.LENGTH_SHORT).show();
                        }
            ...
            Toast.makeText(getApplicationContext(),
                    "Revisa tú conexción ", Toast.LENGTH_SHORT).show();
        }
    }
