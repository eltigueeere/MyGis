 ...
 */
public class MapaActivity extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback {

    private static final String exitTAG = "MapaActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1IjoiZWx0aWd1ZWVlcmUiLCJhIjoiY2p4emJ6czNqMDFmajNucmtza2oxYjFneCJ9.PGdtUkbrPTP0-b0DU2uSng");
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        MapaActivity.this.mapboxMap = mapboxMap;
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull final Style style) {
                ...
                hoveringMarker = new ImageView(MapaActivity.this);
                    ...
                    public void onClick(View view) {
                        if (hoveringMarker.getVisibility() == View.VISIBLE) {
                            ...
                            selectLocationButton.setBackgroundColor(
                                    ContextCompat.getColor(MapaActivity.this, R.color.colorPrimary));
    ...
    private void reverseGeocode(@NonNull final Style style, final Point point) {
        try {
            MapboxGeocoding client = MapboxGeocoding.builder()
                    ...
                    .build();
            final double longitud = point.longitude();
            final double latitud  = point.latitude();
            final String longLat = "LONGITUDE: " + String.valueOf(longitud) + " LATITUDE: " + String.valueOf(latitud);
