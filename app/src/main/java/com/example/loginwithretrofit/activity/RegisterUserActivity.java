...
public class RegisterUserActivity extends Activity implements OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.btnRegister:
                ...
                if (edtName.getText().toString().length() == 0) {
                    ...
                    Toast.makeText(getApplicationContext(), "Nombre En blanco",
                            Toast.LENGTH_LONG).show();
                    edtName.setError("Nombre En blanco");
                    ...
                    Toast.makeText(getApplicationContext(),
                            "( 8 Caracteres Minimo Mayusculas Minusculas y caracteres Especiales ",
                            Toast.LENGTH_LONG).show();
                    edtPassword.setError("8 Caracteres Minimo Mayusculas Minusculas y caracteres Especiales ");
    ...
    private void selectImage() {
        final CharSequence[] items = {"Tomar Foto", "Seleccionar una imagen de la galeria",
                "Cancel"};
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                } else if (items[item].equals("Buscar el la Galeria")) {
            ...
            switch (requestCode) {
                ...
                case REQUEST_CAMERA:
                    ...
                    try {
                        ...
                        String errorMessage = "Lo sentimos - your device doesn't support the crop action!";
    ...
    private void insertData() {
        ...
        dialog.setMessage("Esto puede tardar un momento...");
        dialog.show();
