...
public class EditProfileFragment extends Fragment {
		...
		btnUpdateProfile.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (edtUserName.getText().toString().length() == 0) {
					...
					Toast.makeText(getActivity(), "El usuario no puede ser nulo",
							Toast.LENGTH_LONG).show();
					edtUserName.setError("El usuario no puede ser nulo");
	...
	private void selectImage() {
		final CharSequence[] items = { "Tomar Foto", "Tomar una de la Galeria",
				"Cancelar" };
		...
		builder.setItems(items, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int item) {
				...
				} else if (items[item].equals("Tomar una de la Galeria")) {
	...
	private void updateData() {
		...
		dialog.setMessage("Esto Puede Tardar...");
		dialog.show();
